...
urlpatterns  = [
    ...
    path('salesorder/<int:id>',views.SalesOderHeaderApiView.as_view(), name = 'salesorder'),
    ...
    path('purchaseorder/<int:id>',views.purchaseorderApiView.as_view(), name = 'purchaseorder'),
    path('purchaseorderdetails',views.PurchaseOrderDetailsApiView.as_view(),name = 'purchaseorder'),
    path('purchaseorderdetails/<int:id>',views.PurchaseOrderDetailsApiView.as_view(), name = 'purchaseorder'),
