...
class SalesOderHeader(TrackingModel):
    ...
    totalpieces = models.IntegerField(verbose_name='Terms')
    totalweight =  models.DecimalField(max_digits=10, decimal_places=2 ,verbose_name= 'Total Weight')
    vehicle = models.CharField(max_length=50, verbose_name='Vehicle')
    ...
    shippedto =  models.ForeignKey(to = account, on_delete= models.CASCADE,related_name='shippedto')
    remarks = models.CharField(max_length=500,verbose_name= 'Remarks')
    transport =  models.ForeignKey(to = account, on_delete= models.CASCADE,blank=True,related_name='transport')
    broker =  models.ForeignKey(to = account, on_delete= models.CASCADE,blank=True,related_name='broker')
    tds194q =  models.DecimalField(max_digits=10, decimal_places=2, verbose_name= 'TDS 194 @')
    tcs206c1ch1 =  models.DecimalField(max_digits=10, decimal_places=2 ,verbose_name= 'Tcs 206C1cH1')
    tcs206c1ch2 =  models.DecimalField(max_digits=10, decimal_places=2, verbose_name= 'Tcs 206C1cH2')
    tcs206c1ch3 =  models.DecimalField(max_digits=10, decimal_places=2, verbose_name= 'Tcs tcs206c1ch3')
    tcs206C1 =  models.DecimalField(max_digits=10, decimal_places=2 ,verbose_name= 'Tcs 206C1')
    tcs206C2 =  models.DecimalField(max_digits=10, decimal_places=2,verbose_name= 'Tcs 206C2')
