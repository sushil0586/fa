...
class Product(TrackingModel):
    ...
    prlesspercentage = models.DecimalField(max_digits=10, decimal_places=2,default=True,blank=True)
    mrp = models.DecimalField(max_digits=10, decimal_places=2,default=True,blank=True)
    mrpless = models.DecimalField(max_digits=10, decimal_places=2,default=True,blank=True)
    salesprice = models.DecimalField(max_digits=10, decimal_places=2,default=True,blank=True)
    totalgst = models.DecimalField(max_digits=10, decimal_places=2,default=True,blank=True)
    cgst = models.DecimalField(max_digits=10, decimal_places=2,default=True,blank=True)
    cgstcess = models.DecimalField(max_digits=10, decimal_places=2,default=True,blank=True)
    sgst = models.DecimalField(max_digits=10, decimal_places=2,default=True,blank=True)
